...
try:
	# local dev 5432
	conn = psycopg2.connect(user = "ballotnav", password = "", host = "127.0.0.1", port = "5432", database = "ballotnav_dev")
	# docker-dev 5434
	#conn = psycopg2.connect(user = "ballotnav", password = "pgpass", host = "127.0.0.1", port = "5434", database = "main")
	# rds-dev 5435
	#conn = psycopg2.connect(user = "ballotnav", password = "", host = "127.0.0.1", port = "5435", database = "main")
	# rds-prod 5436
	#conn = psycopg2.connect(user = "ballotnav", password = "", host = "127.0.0.1", port = "5436", database = "main")
	cursor = conn.cursor()
