      ...
      <div className="Volunteer-wrapper">
        ...
        <div className="cards-wrapper">
          ...
          <div className="volunteer-card">
            <h3>Translators</h3>
            <p>
              Our app's greatest flaw is its limitation to English, and we
              desperately need translators who can help us better serve
        ...
        <div className="apply-wrapper">
          <div>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              href="mailto: ballotnav@hackforla.org"
            >
              Contact Us
            </a>
          </div>
