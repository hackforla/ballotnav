  ...
  return (
    <div className={classes.root}>
      <p>
        ...
        to have useful resources for those hoping to have their voices heard.{' '}
      </p>
      <br />
      <p>
        ...
        information, such as available ballot drop-off times. The BallotNav
        project will collect this data through a network of brigade partnerships
        and update it accordingly leading up to mid-term elections in 2022.
      </p>
    </div>
  )
}
