...
const fields = {
  ...
  displayNote: {
    ...
    field: 'display_note',
    allowNull: true,
    helperText: 'Info that will help the public find/use the location, e.g. "dropbox is inside next to coffee shop"',
  },
  internalNote: {
    type: 'textarea',
    field: 'internal_note',
    allowNull: true,
    helperText: 'Info for internal use -- not for public display',
  },
  scheduleType: {
